# Generate satellite network state for Naive-based LMSR algorithm
import sys
...
# Reduced constellation for testing: 210 satellites (21 orbits × 10 sats/orbit)
NUM_ORBS = 21  # Keep original number of orbits
NUM_SATS_PER_ORB = 10  # Reduce from 30 to 10
# Total satellites: 21 * 10 = 210 (1/3 of original 630)
...
name = "kuiper_126_isls_" + dynamic_state_algorithm  # Changed from kuiper_630
...
satgen.help_dynamic_state(
    ...
    True  # Enable verbose to see progress
)
